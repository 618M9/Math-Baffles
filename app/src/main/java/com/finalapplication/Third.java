...
public class Third extends AppCompatActivity {
    ...
    public void setQuestion()
    {
        ...
        if(index==2 || index==6 ||index==8 ||index==10 ||index==12 || index==15 || index==18 ||index==4 || index==0|| index==19 || index==16 || index==13)
        {
    ...
    private void chkAns(String s)
    {
        if(s.equals(crctAns))
        {
            ...
            Animation animation=AnimationUtils.loadAnimation(Third.this,R.anim.slide_in_right);
            ...
            if(index==20 && !pre)
            {
                ...
                View view=layoutInflater.inflate(R.layout.last_question_hard_toast,(ViewGroup)findViewById(R.id.hardToast));
                Toast toast=new Toast(Third.this);
                toast.setDuration(Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER,0,0);
                toast.setView(view);
                toast.show();
            }
            if(index!=3 && !pre&& index!=7 && index!=9 && index!=11 && index!=13 && index!=16 && index!=19 && index!=5 && index!=1&& index!=20 && index!=17 && index!=14)
            {
                LayoutInflater layoutInflater=getLayoutInflater();
        ...
        else
        {
            ...
            if(index!=3 && index!=7 && index!=9 && index!=11 && index!=13 && index!=16 && index!=19 && index!=5 && index!=1&& index!=20 && index!=17 && index!=14)
            {
                LayoutInflater layoutInflater=getLayoutInflater();
    ...
    public void onBackPressed() {
        ...
        MainMenu.kuntaSelect=3;
        Splash_screen.Rlayout=1;

        Intent er=new Intent(Third.this,MainMenu.class);
        startActivity(er);
